...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRACEN_HW_PRESENT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRACEN_PROVISION_PROT_RAM_INV_DATA, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_CRACEN, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_HW_NRF_PWM20, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ENTROPY_NRF_CRACEN_CTR_DRBG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEGGER_SYSVIEW_RTT_CHANNEL, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SEGGER_SYSVIEW_APP_NAME, 1);
